...
All text objects are designed to work with [[https://github.com/noctuid/targets.e][targets.el]], and it is highly recommended that you use it if only for these text objects as they will work much better:
